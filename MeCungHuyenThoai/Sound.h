...
public:
	SoundEffect();
	~SoundEffect();
	bool LoadSound(std::string climb_path, std::string crystal_pick_up_path, std::string mana_pick_up_path, std::string jump_path, std::string land_path, std::string fire_path, std::string death_path, std::string walk_path, std::string background_path, std::string victory_path);
	void free();
